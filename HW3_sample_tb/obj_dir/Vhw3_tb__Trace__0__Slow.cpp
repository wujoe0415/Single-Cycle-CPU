...
VL_ATTR_COLD void Vhw3_tb___024root__trace_init_sub__TOP__0(Vhw3_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+151,"finish", false,-1);
    tracep->pushNamePrefix("hw3_tb ");
    tracep->declBit(c+149,"clk", false,-1);
    tracep->declBit(c+150,"rst", false,-1);
    tracep->declBit(c+151,"finish", false,-1);
    tracep->declBus(c+152,"DWIDTH", false,-1, 31,0);
    tracep->declBus(c+18,"i", false,-1, 31,0);
    tracep->declBus(c+153,"tmp", false,-1, 31,0);
    tracep->declBus(c+19,"cycle_count", false,-1, 31,0);
    tracep->declBus(c+154,"cycle_for_ans", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
    ...
    tracep->declBit(c+149,"clk", false,-1);
    tracep->declBit(c+150,"rst", false,-1);
    tracep->declBus(c+155,"J_TYPE_NOP", false,-1, 2,0);
    tracep->declBus(c+156,"J_TYPE_BEQ", false,-1, 2,0);
    tracep->declBus(c+157,"J_TYPE_JAL", false,-1, 2,0);
    tracep->declBus(c+158,"J_TYPE_JR", false,-1, 2,0);
    tracep->declBus(c+159,"J_TYPE_J", false,-1, 2,0);
    ...
    tracep->declBus(c+160,"OP_AND", false,-1, 3,0);
    tracep->declBus(c+161,"OP_OR", false,-1, 3,0);
    tracep->declBus(c+162,"OP_ADD", false,-1, 3,0);
    tracep->declBus(c+163,"OP_SUB", false,-1, 3,0);
    tracep->declBus(c+164,"OP_NOR", false,-1, 3,0);
    tracep->declBus(c+165,"OP_SLT", false,-1, 3,0);
    ...
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("jump_addr_inst ");
    tracep->declBus(c+69,"pc", false,-1, 31,0);
    tracep->declBus(c+87,"jump_addr", false,-1, 31,0);
    tracep->declBus(c+112,"answer_jump", false,-1, 31,0);
    tracep->declBus(c+167,"decode_shift", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("mux2_1_inst ");
    tracep->declBus(c+74,"alu_rd", false,-1, 31,0);
    tracep->declBus(c+94,"dmem_rdata", false,-1, 31,0);
    tracep->declBus(c+113,"decode_lw", false,-1, 31,0);
    tracep->declBus(c+114,"reg_rdst", false,-1, 31,0);
    tracep->popNamePrefix(1);
    tracep->pushNamePrefix("mux4_1_inst ");
    tracep->declBus(c+82,"decode_ssel", false,-1, 1,0);
    ...
    tracep->declBus(c+115,"jump_type", false,-1, 1,0);
    tracep->declBus(c+77,"adder_result1", false,-1, 31,0);
    tracep->declBus(c+112,"jump_address", false,-1, 31,0);
    ...
    tracep->declBus(c+115,"select", false,-1, 1,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+85,"rdst_id", false,-1, 4,0);
    tracep->declBus(c+114,"rdst", false,-1, 31,0);
    tracep->declBus(c+72,"rs1", false,-1, 31,0);
    tracep->declBus(c+93,"rs2", false,-1, 31,0);
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+116+i*1,"R", true,(i+0), 31,0);
    }
...
VL_ATTR_COLD void Vhw3_tb___024root__trace_full_sub_0(Vhw3_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+82,(vlSelf->hw3_tb__DOT__core_top_inst__DOT___SSEL),2);
    ...
    tracep->fullIData(oldp+87,(((vlSelf->hw3_tb__DOT__core_top_inst__DOT___RDATA 
                                 >> 0x1fU) ? 0U : (
                                                   (0x40000000U 
    ...
    tracep->fullIData(oldp+112,(vlSelf->hw3_tb__DOT__core_top_inst__DOT___JUMP_ADDR),32);
    tracep->fullIData(oldp+113,((IData)((0x8c000000U 
                                         == (0xfc000000U 
                                             & vlSelf->hw3_tb__DOT__core_top_inst__DOT___RDATA)))),32);
    tracep->fullIData(oldp+114,(((IData)((0x8c000000U 
                                          == (0xfc000000U 
                                              & vlSelf->hw3_tb__DOT__core_top_inst__DOT___RDATA)))
    ...
    tracep->fullCData(oldp+115,((3U & (IData)(vlSelf->hw3_tb__DOT__core_top_inst__DOT___JT))),2);
    tracep->fullIData(oldp+116,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[0]),32);
    tracep->fullIData(oldp+117,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[1]),32);
    tracep->fullIData(oldp+118,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[2]),32);
    tracep->fullIData(oldp+119,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[3]),32);
    tracep->fullIData(oldp+120,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[4]),32);
    tracep->fullIData(oldp+121,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[5]),32);
    tracep->fullIData(oldp+122,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[6]),32);
    tracep->fullIData(oldp+123,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[7]),32);
    tracep->fullIData(oldp+124,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[8]),32);
    tracep->fullIData(oldp+125,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[9]),32);
    tracep->fullIData(oldp+126,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[10]),32);
    tracep->fullIData(oldp+127,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[11]),32);
    tracep->fullIData(oldp+128,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[12]),32);
    tracep->fullIData(oldp+129,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[13]),32);
    tracep->fullIData(oldp+130,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[14]),32);
    tracep->fullIData(oldp+131,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[15]),32);
    tracep->fullIData(oldp+132,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[16]),32);
    tracep->fullIData(oldp+133,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[17]),32);
    tracep->fullIData(oldp+134,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[18]),32);
    tracep->fullIData(oldp+135,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[19]),32);
    tracep->fullIData(oldp+136,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[20]),32);
    tracep->fullIData(oldp+137,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[21]),32);
    tracep->fullIData(oldp+138,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[22]),32);
    tracep->fullIData(oldp+139,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[23]),32);
    tracep->fullIData(oldp+140,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[24]),32);
    tracep->fullIData(oldp+141,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[25]),32);
    tracep->fullIData(oldp+142,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[26]),32);
    tracep->fullIData(oldp+143,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[27]),32);
    tracep->fullIData(oldp+144,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[28]),32);
    tracep->fullIData(oldp+145,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[29]),32);
    tracep->fullIData(oldp+146,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[30]),32);
    tracep->fullIData(oldp+147,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__R[31]),32);
    tracep->fullIData(oldp+148,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__reg_file_inst__DOT__unnamedblk1__DOT__i),32);
    tracep->fullBit(oldp+149,(vlSelf->clk));
    tracep->fullBit(oldp+150,(vlSelf->rst));
    tracep->fullBit(oldp+151,(vlSelf->finish));
    tracep->fullIData(oldp+152,(0x20U),32);
    tracep->fullIData(oldp+153,(vlSelf->hw3_tb__DOT__tmp),32);
    tracep->fullIData(oldp+154,(8U),32);
    tracep->fullCData(oldp+155,(0U),3);
    tracep->fullCData(oldp+156,(1U),3);
    tracep->fullCData(oldp+157,(2U),3);
    tracep->fullCData(oldp+158,(3U),3);
    tracep->fullCData(oldp+159,(4U),3);
    tracep->fullCData(oldp+160,(0U),4);
    tracep->fullCData(oldp+161,(1U),4);
    tracep->fullCData(oldp+162,(2U),4);
    tracep->fullCData(oldp+163,(6U),4);
    tracep->fullCData(oldp+164,(0xcU),4);
    tracep->fullCData(oldp+165,(7U),4);
    tracep->fullCData(oldp+166,(0xfU),4);
    tracep->fullIData(oldp+167,(vlSelf->hw3_tb__DOT__core_top_inst__DOT__jump_addr_inst__DOT__decode_shift),32);
}
